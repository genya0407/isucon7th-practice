...
<html>
  ...
  <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
	...
	qw422016.E().S(h.User.Name)
	//line history.qtpl:43
	qw422016.N().S(`" class="nav-link">`)
	//line history.qtpl:43
	qw422016.E().S(h.User.DisplayName)
	//line history.qtpl:43
	qw422016.N().S(`</a></li>
  ...
  <div class="row">
	...
	for _, msg := range h.Messages {
		...
		qw422016.E().S(msg.UserAvatarIcon)
		//line history.qtpl:71
		...
		qw422016.N().S(`">`)
		//line history.qtpl:73
		qw422016.E().S(msg.UserDisplayName)
		//line history.qtpl:73
		qw422016.N().S(`@`)
		//line history.qtpl:73
		qw422016.E().S(msg.UserName)
		...
		qw422016.E().S(msg.MessageContent)
		//line history.qtpl:74
		qw422016.N().S(`</p>
